<%-- 
    Document   : header
    Created on : 22/02/2024, 10:10:35 AM
    Author     : edugu
--%>
...
<!-----------------------------/BOOTSTRAP----------------------------->
    ...
    <body style="background-color: #a6e1ec">
        ...
        <div class="container">
            <div class="jumbotron">
                <center>
                    <h3><i>Prueba JSP Server GUZMAN</i></h3>
                </center>
            </div>
        </div>
   <!--Barra de navegacion-->
         ...
         <nav class="navbar navbar-default navbar-fixed-top navbar-inverse" role="navigation">
             <div class="container-fluid">
                 <div class="navbar-header">
                     ...
                     <a class="navbar-brand" href="#">UDL</a>
                 </div>
      ...
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              <div class="modal-header">
                  ...
                  <center><h4 class="modal-title">Ventana Servidores Gama Alta GUZMAN</h4></center>
              </div>
...
<script>
 ...
 <!--/Modal-->
        ...
        <!--Inicia Carousel-->
        <br><br>
        <center><h1>Infraestructura  ASI GUZMAN</h1></center>
        ...
        <div class="carousel-inner" role="listbox"> <!--Carousel inner-->
              ...
              <div class="item active">
                  <center>  <img src="imagenes/cell1.jpg" alt="cell1" width="460" height="450"></center>
              ...
              <div class="item">
             <center>     <img src="imagenes/cell2.jpg" alt="cell2" width="460" height="450"></center>
                <div class="carousel-caption">
                   <h1>Producto 2 </h1>
                   <p>Caracteristicas breves del producto</p>  
                   <span class="badge">$6000</span>
              ...
              <div class="item">
                 <center> <img src="imagenes/cell3.jpg" alt="cell3" width="460" height="450"></center>
                <div class="carousel-caption">
                   <h1>Producto 3 </h1>
                   <p>Caracteristicas breves del producto</p>  
                   <span class="badge">$6000</span>
              ...
              <div class="item">
               <center>   <img src="imagenes/cell4.jpg" alt="cell4" width="460" height="450"></center>
                <div class="carousel-caption">
                   <h1>Producto 4 </h1>
                   <p>Caracteristicas breves del producto</p>  
                   <span class="badge">$6000</span>
              ...
              <div class="item">
               <center>   <img src="imagenes/cell5.jpg" alt="cell5" width="460" height="450"></center>
                <div class="carousel-caption">
                   <h1>Producto 5 </h1>
